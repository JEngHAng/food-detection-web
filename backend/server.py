...
MENU_RULES = [
    {
        "menu": "ข้าวมันไก่ต้ม",
        "must_have": ["ข้าวมันไก่", "ไก่ต้ม", "ข้าว"],
        "optional": ["เลือดไก่ต้ม", "แตงกวา"]
    },
    {
        "menu": "ข้าวมันไก่ทอด",
        "must_have": ["ข้าวมันไก่", "ไก่ทอด", "ข้าว"],
        "optional": ["แตงกวา"]
    },
    {
        "menu": "ข้าวมันไก่ทอดไก่ต้ม",
        "must_have": ["ข้าวมันไก่", "ไก่ทอด", "ไก่ต้ม", "ข้าว"],
        "optional": ["เลือดไก่ต้ม", "แตงกวา"]
    },
    {
        "menu": "ข้าวหมูแดงหมูกรอบ",
        "must_have": ["ข้าวหมูแดงหมูกรอบ", "ข้าว", "กุนเชียง", "หมูกรอบ", "ไข่ต้ม"],
        "optional": ["แตงกวา"]
    },
    {
        "menu": "ก๋วยเตี๋ยวไก่น่องตุ๋นยาจีน",
        "must_have": ["ก๋วยเตี๋ยว", "น่องไก่"],
        "optional": ["เลือดไก่ต้ม", "ไชเท้า"]
    },
    {
        "menu": "ก๋วยเตี๋ยวไก่ฉีกตุ๋นยาจีน",
        "must_have": ["ก๋วยเตี๋ยว", "ไก่ฉีก"],
        "optional": ["เลือดไก่ต้ม", "ไชเท้า"]
    },
    {
        "menu": "ข้าวกะเพราหมูสับ",
        "must_have": ["กะเพรา", "หมูสับ", "ข้าว"],
        "optional": []
    },
    {
        "menu": "ข้าวกะเพราหมูสับเต้าหู้",
        "must_have": ["กะเพรา", "หมูสับ", "ข้าว", "เต้าหู้ทอด"],
        "optional": []
    },
]
